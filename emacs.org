...
** Google
   ...
   Binds a whole lot of functions under =C-c /=, I tend to use =C-c RET=
   which just starts a google search from the minibuffer. 
   ...
   #+BEGIN_SRC emacs-lisp
     (use-package helm-bibtex
       ...
       (setq bibtex-completion-bibliography "~/Dropbox/bibliography/references.bib"
             ...
             bibtex-completion-notes-template-one-file my/notes-template
             )
...
** Helm and syntax checking
   ...
   #+END_SRC
** Helm and google
   Helm contains =helm-google-suggest= which allows you to google things
   from within emacs, but this package lets you browse the results
   from within emacs as well. I also set up a better keybinding for
   =helm-google-suggest= (the default is =C-c h C-c g= which is ridiculous)
   ...
   #+BEGIN_SRC emacs-lisp
     (use-package org-ref
       ...
       (setq org-ref-bibliography-notes "~/Dropbox/bibliography/notes.org"
             ...
             org-ref-note-title-format my/notes-template)
       :config
