...
#+END_SRC
Bind to my personal keymap:
#+BEGIN_SRC emacs-lisp
  (bind-key "f" #'my/toggle-serif my/map)
#+END_SRC
...
Bind that function in my personal keymap, and make ~quick-calc~ easier to get to as well:
#+BEGIN_SRC emacs-lisp
  (bind-keys
   :map my/map
...
#+END_SRC
*** Org habits
Enable org habits: [[info:org#Tracking%20your%20habits][info:org#Tracking your habits]]
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  (use-package org-gcal
    ...
    (add-to-list 'org-capture-templates
                 `("a" "Appointment" entry (file ,(cdr (car org-gcal-file-alist)))
                   "* %?\n  %^T"))
