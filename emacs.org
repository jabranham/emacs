...
** Helm and email
   ...
   #+END_SRC
** Helm and spellcheck
Helm can mange the spell checking that we do. 
   #+BEGIN_SRC emacs-lisp
     (use-package helm-flyspell
       :ensure t
       :config
       (define-key flyspell-mode-map (kbd "C-x I") 'helm-flyspell-correct))
   #+END_SRC
...
** References (org-ref) 
   ...
   #+BEGIN_SRC emacs-lisp
     (use-package org-ref
       ...
       :config
       (bind-key* "C-c C-r"  #'org-ref-helm-insert-cite-link)
