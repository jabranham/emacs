...
Define a mode that centers and fills the text:
#+BEGIN_SRC emacs-lisp
  (define-minor-mode my/center-and-fill-mode
    "Center and fill the text for a nice visual effect." nil "C-F" nil
    (progn
...
Add hooks for that:
#+BEGIN_SRC emacs-lisp
  (add-hook 'text-mode-hook #'my/center-and-fill-mode)
#+END_SRC
