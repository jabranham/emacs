...
** Sticky headers
This makes the headers stick around if they would otherwise scroll off the top of the screen.
I configure it to show the full path, starting with the first-level heading.
I've got wide screens, might as well use them!
#+BEGIN_SRC emacs-lisp
  ;;;; Sticky Header Line
  ...
  (use-package org-sticky-header
    ...
    ;; Always show the header if the option to show the full or reversed path is set.
